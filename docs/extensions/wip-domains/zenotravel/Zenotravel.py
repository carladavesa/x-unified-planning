...
# Run: python -m docs.extensions.domains.zenotravel.Zenotravel --compilation ut-integers --solving fast-downward
...
fuel = Fluent('fuel', IntType(0,60), a=aircraft)
distance = Fluent('distance', IntType(0, 3), c1=city, c2=city)
slow_burn = Fluent('slow_burn', IntType(4,4), a=aircraft)
fast_burn = Fluent('fast_burn', IntType(15,15), a=aircraft)
capacity = Fluent('capacity', IntType(60,60), a=aircraft)
total_fuel_used = Fluent('total_fuel_used', IntType(0,10))
onboard = Fluent('onboard', IntType(0,60), a=aircraft)
...
zenotravel_problem.set_initial_value(capacity(plane1), 60)
zenotravel_problem.set_initial_value(fuel(plane1), 40)
...
zenotravel_problem.set_initial_value(distance(city0, city1), 2)
zenotravel_problem.set_initial_value(distance(city0, city2), 2)
zenotravel_problem.set_initial_value(distance(city1, city0), 2)
zenotravel_problem.set_initial_value(distance(city1, city1), 0)
zenotravel_problem.set_initial_value(distance(city1, city2), 2)
zenotravel_problem.set_initial_value(distance(city2, city0), 2)
zenotravel_problem.set_initial_value(distance(city2, city1), 3)
