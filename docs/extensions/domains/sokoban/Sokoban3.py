...
instance = subprocess.run(['python3', '/Users/cds26/PycharmProjects/unified-planning/experiments/sokoban/read_instance.py', 'i_12'], text=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
for (r, c), v in initial_state.items():
    sokoban_problem.set_initial_value(grid[r][c](eval(v)), True)

for r in range(rows):
    for c in range(columns):
        if (r,c) not in initial_state.keys() and (r,c) not in undefined_positions:
            sokoban_problem.set_initial_value(grid[r][c](E), True)
...
move_right.add_precondition(grid[r][c+1](E))
move_right.add_effect(grid[r][c](E), True)
move_right.add_effect(grid[r][c+1](P), True)
move_right.add_effect(grid[r][c](P), False)
move_right.add_effect(grid[r][c+1](E), False)
...
move_left.add_precondition(grid[r][c-1](E))
move_left.add_effect(grid[r][c](E), True)
move_left.add_effect(grid[r][c-1](P), True)
move_left.add_effect(grid[r][c](P), False)
move_left.add_effect(grid[r][c-1](E), False)
...
move_up.add_precondition(grid[r-1][c](E))
move_up.add_effect(grid[r][c](E), True)
move_up.add_effect(grid[r-1][c](P), True)
move_up.add_effect(grid[r][c](P), False)
move_up.add_effect(grid[r-1][c](E), False)
...
move_down.add_precondition(grid[r+1][c](E))
move_down.add_effect(grid[r][c](E), True)
move_down.add_effect(grid[r+1][c](P), True)
move_down.add_effect(grid[r][c](P), False)
move_down.add_effect(grid[r+1][c](E), False)
...
push_box_right.add_precondition(grid[r][c+2](E))
push_box_right.add_effect(grid[r][c](E), True)
...
push_box_right.add_effect(grid[r][c+2](E), False)
...
push_box_left.add_precondition(grid[r][c-2](E))
push_box_left.add_effect(grid[r][c](E), True)
...
push_box_left.add_effect(grid[r][c-2](E), False)
...
push_box_up.add_precondition(grid[r-2][c](E))
push_box_up.add_effect(grid[r][c](E), True)
...
push_box_up.add_effect(grid[r-2][c](E), False)
...
push_box_down.add_precondition(grid[r+2][c](E))
push_box_down.add_effect(grid[r][c](E), True)
...
push_box_down.add_effect(grid[r+2][c](E), False)
