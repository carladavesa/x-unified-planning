...
class CompilationKind(Enum):
    ...
    COUNT_TO_BOOL_REMOVING = auto()
    COUNT_TO_INT_REMOVING = auto()
    ARRAY_FLUENTS_REMOVING = auto()
    SET_FLUENTS_REMOVING = auto()
    INT_PARAMETERS_AND_VARIABLES_REMOVING = auto()
    INTEGER_FLUENTS_GENERAL_REMOVING = auto()
    INTEGER_FLUENTS_BASIC_REMOVING = auto()
    LOGARITHMIC_REMOVING = auto()
