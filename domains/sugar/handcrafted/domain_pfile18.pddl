...
(:predicates  (at-location_truck2_mill1)
...
(:action changeproduct__mill1__brand1__brand2
	...
	:precondition (and  (current-process_mill1_brand1))
	:effect (and 
			(decrease (max-changing_mill1) 1.0)			(not (current-process_mill1_brand1))			(current-process_mill1_brand2)
))
...
(:action drivetruck__truck2__mill1__mill2
	...
	:precondition (and  (at-location_truck2_mill1))
	:effect (and 
			(not (at-location_truck2_mill1))			(at-location_truck2_mill2)
))
...
(:action loadtruckmanual__brand2__truck2__mill2
	:parameters ()
	:precondition (and (> (in-storage_mill2_brand2) 0.0)(> (truck-cap_truck2) 0.0) (at-location_truck2_mill2))
	:effect (and 
