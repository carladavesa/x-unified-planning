(define (problem rush-hour-pp)
    ...
    (:objects
        ...
        red vehicle1 vehicle2 vehicle3 vehicle4 vehicle5 vehicle6 vehicle7 vehicle8 vehicle9 vehicle10 vehicle11 vehicle12 vehicle13 vehicle14 - vehicle
    )
    (:init
        (= (total-cost) 0)
        ...
        (containsVehicle loc4_2 vehicle6)
