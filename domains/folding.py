...
INSTANCES: Dict[str, tuple[int, int, list[tuple[int, int]], list[tuple[int, int]]]] = {
    "example2": (2, 2, [(1,0), (0,0)], [(1,0), (1,1)]),
    "example3": (3, 3, [(2,0), (1,0), (0,0)], [(2,0), (2,1), (1,1)]),
    "example4": (4, 4, [(3,0), (2,0), (1,0), (0,0)], [(3,0), (3,1), (2,1), (2,2)]),
    "example5": (5, 5, [(4,0), (3,0), (2,0), (1,0), (0,0)], [(4,0), (4,1), (3,1), (3,0), (2,0)]),
    "example6": (6, 6, [(5,0), (4,0), (3,0), (2,0), (1,0), (0,0)], [(5,0), (4,0), (4,1), (3,1), (3,0), (2,0)]),
    "example8": (8, 8, [(7,0), (6,0), (5,0), (4,0), (3,0), (2,0), (1,0), (0,0)], [(7,0), (6,0), (6,1), (7,1), (7,2), (7,3), (7,4), (7,5)]),
    "example10": (10, 10, [(9,0), (8,0), (7,0), (6,0), (5,0), (4,0), (3,0), (2,0), (1,0), (0,0)], [(9,0), (8,0), (7,0), (7,1), (8,1), (8,2), (8,3), (7,3), (7,2), (6,2)]),
    "o01": (15, 15, [(7, 7), (6, 7), (5, 7), (4, 7), (3, 7), (2, 7), (1, 7), (0, 7)], [(7, 7), (7, 8), (8, 8), (8, 7), (9, 7), (9, 8), (10, 8), (10, 9)]),
    "o03": (23, 23, [(11, 11), (10, 11), (9, 11), (8, 11), (7, 11), (6, 11), (5, 11), (4, 11), (3, 11), (2, 11), (1, 11), (0, 11)], [(11, 11), (11, 10), (10, 10), (10, 9), (9, 9), (9, 8), (8, 8), (7, 8), (7, 7), (8, 7), (8, 6), (7, 6)]),
}
